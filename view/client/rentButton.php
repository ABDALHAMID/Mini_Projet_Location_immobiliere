...
var_dump($isTheOrderExest);

if($isTheOrderExest){
    echo '<script> console.log(\''.$isItRented['status'].':true\')</script>';
}
else {
    echo '<script> console.log(\''.$isItRented['status'].':false\')</script>';
}
...
if (isset($_SESSION["id"])) {
    ...
    echo '<button class="notAllowedButton" onClick="showAlert(\'you need to login first to rent this:\', \'click to login\', \'alert-danger\')">
