                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a"><a href="#">'.$logement["adresse"].'</a></h2>
                    </div>
                    <div class="card-body-a">
                      <div class="price-box d-flex">
                        <span class="price-a">rent | '.$logement["prix"].'</span>
                      </div>
                      <a href="'.$_SERVER['PHP_SELF'].'?page=logement&id='.$logement['id'].'" class="link-a">Click here to view<span class="bi bi-chevron-right"></span></a>
                    </div>
