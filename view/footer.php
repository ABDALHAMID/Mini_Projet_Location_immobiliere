        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">Rentit</h3>
            </div>
            <div class="w-body-a">
              <p class="w-text-a color-text-a">
                Votre confort est notre responsabilité .
              </p>
            </div>
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Téléphone .</span> Rentit@gmail.com
                </li>
                <li class="color-a">
                  <span class="color-text-a">Email .</span> +212 5550077
                </li>
              </ul>
            </div>
          </div>
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Rentit</span> All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
