  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch">
    ...
    <ul class="navbar-nav navbar-nav-right">
      <li class="nav-item nav-profile dropdown">
        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#profile" data-bs-toggle="dropdown"
          aria-expanded="false">
      ...
      <li class="nav-item nav-logout d-none d-lg-block">
        <a href="<?php echo $_SERVER['PHP_SELF']. '?page=logout'  ?>" class="text-reset nav-link">
