              ...
              <div class="auth-form-light text-left p-5">
                ...
                <form class="pt-3" action="<?php echo $_SERVER['PHP_SELF'].'?page=adduser'; ?>" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="name" placeholder="prenom" name="name">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" id="adresse" placeholder="nom" name="adresse">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="number" class="form-control form-control-lg" id="baths" placeholder="lits" name="baths">
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control form-control-lg" id="garage" placeholder="lits" name="garage">
                  </div>
                  <div class="form-group">
                    <input type="number" class="form-control form-control-lg" id="city" placeholder="lits" name="city">
                  </div>
